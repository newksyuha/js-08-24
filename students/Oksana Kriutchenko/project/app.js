...
const app = new Vue({
    ...
    methods: {
        ...
        isVisibleCart() {
                if (document.querySelector(".basketPanel").style.display === "block") {
                    document.querySelector(".basketPanel").style.display = "none";
                } else if (document.querySelector(".basketPanel").style.display === "none") {
                    document.querySelector(".basketPanel").style.display = "block";
                };
       },
